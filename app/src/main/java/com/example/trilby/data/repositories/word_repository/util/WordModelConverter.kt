...
//fun WordEntity.toExternal(): ShowWord {
//    val gson = Gson()
...
//fun List<WordEntity>.toExternal(): List<ShowWord> {
//    return this.map(WordEntity::toExternal)
 ...
 */
//fun FbWord.toExternal() = Word(
//    wordId = this.wordId,
////    wordUuid = uuid,
//    headword = this.hwi.hw,
//    wordPrs = this.hwi.prs?.toExternalPrs(),
//    label = this.fl,
...
//fun List<FbWord>.toExternal(): List<ShowWord> {
//    val wordList = this.map(FbWord::toExternal)
//    val showWordList = wordList.groupBy { it.wordId.substringBefore(":") }
//        .map { (uid, words) -> ShowWord(uid = uid, words = words) }
//    return showWordList
//}
////fun List<FbWord>.toExternal(): List<Word> = map(FbWord::toExternal)
//
...
//fun ShowWord.toFirestore(): List<FbWord> {
//    val firestoreWordList = this.words.map { it.toFirestore() }
//    return firestoreWordList
//}
//
//fun Word.toFirestore(): FbWord {
//    return FbWord(
//        wordId = this.wordId,
//        fl = this.label,
//        hwi = FirestoreHwi(
//            hw = this.headword,
//            prs = this.wordPrs?.toFirestorePrs()
//        ),
////        id = wordId,
//        shortdef = this.shortDef
//    )
